...
class __TwigTemplate_403bbd6b46533d0becfc5274d1da1142 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"boxautres\">
        <div class=\"itemautres\">
            ...
            <h6 >
             ...
             à la sauce rpg (type yu-gi-oh), les batailles navales, sont des moments que j'aime savourer entre deux lignes de bus ou durant une salle d'attente
              </p>
        </div>
        <div class=\"itemautres\">
        ...
        <div class=\"itemautres\">
            ...
            <h6 >
              <p style=\"color:rgb(204, 207, 206);\">
             Jouer aux jeux-vidéo c'est quelque chose, en créer s'en est une autre, tel est la leçon que je appris lorsque j'ai décidé par curiosité
             de me lancer dans le monde du gamemakin. Détenir le fil du scénario, inventer de nouvelles mécanismes de gameplay, designer une palette de personnage et de 
        ...
        <div class=\"itemautres\">
            ...
            <h6 >
              <p style=\"color:rgb(204, 207, 206);\">
              Ma relation avec la science à toujours été une relation trés compliqué, du fait de la complexité de cette derniére (je ne ferai pas de blagues sur les femmes)
              ...
              ( préférence pour la physique et la biologie), mais si ça lui arrive parfois qu'elle dérive dans des exubérations au caractére douteux elle n'en reste pas moins très plaisante
              à suivre.
              </p>
        </div>
        <div class=\"itemautres\">
            ...
            <h6 >
             ...
             que le terre recéle, il n'y a trés clairement rien de plus beau pour les yeux.
              </p>
        </div>
    </div>       
";
...
{% endblock %}
", "boye/autres.html.twig", "C:\\Users\\admin\\Documents\\GitHub\\ProjetSAE104\\templates\\boye\\autres.html.twig");
    }
}
